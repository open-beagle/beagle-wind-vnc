...
RUN echo "Install ComfyUI" && \
    ...
    curl -ko $HOME/ComfyUI_0.3.43_install.sh https://www.bc-cloud.com/maas/api/static/software/ComfyUI0.3.43/install.sh && bash  $HOME/ComfyUI_0.3.43_install.sh /usr/local/lib
