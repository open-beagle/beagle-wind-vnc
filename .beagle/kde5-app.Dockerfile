...
# BDWind Desktop Default Stream Parameters
ENV BDWIND_ENCODER=x264
ENV BDWIND_RESOLUTION=1920x1080
ENV BDWIND_VIDEO_BITRATE=12000
ENV BDWIND_AUDIO_BITRATE=24000
ENV BDWIND_FRAMERATE=60
