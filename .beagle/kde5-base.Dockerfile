...
RUN --mount=type=bind,source=KDE5/base/scripts/,target=/etc/beagle-wind-vnc/scripts/ \
...
RUN --mount=type=bind,source=KDE5/base/scripts/,target=/etc/beagle-wind-vnc/scripts/kde5/ \
    bash /etc/beagle-wind-vnc/scripts/kde5/install-xorg.sh && \
    bash /etc/beagle-wind-vnc/scripts/kde5/install-xvfb.sh && \
    bash /etc/beagle-wind-vnc/scripts/kde5/install-virtualgl.sh
...
RUN --mount=type=bind,source=KDE5/base/scripts/,target=/etc/beagle-wind-vnc/scripts/kde5/ \
    bash /etc/beagle-wind-vnc/scripts/kde5/install-plasma.sh
