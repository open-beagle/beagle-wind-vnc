...
RUN bgctl alias set default $S3_URL $S3_ACCESS_KEY $S3_ACCESS_SECRET && \
    ...
    bgctl cp default/cache/cuda/cuda-ubuntu2404.pin /etc/apt/preferences.d/cuda-repository-pin-600 && \
    bgctl cp default/cache/cuda/cuda-repo-ubuntu2404-12-8-local_12.8.0-570.86.10-1_amd64.deb /tmp/cuda-repo-ubuntu2404-12-8-local_12.8.0-570.86.10-1_amd64.deb && \
    ...
    echo "Install cudnn" && \
    bgctl cp default/cache/cuda/cudnn-local-repo-ubuntu2404-9.10.2_1.0-1_amd64.deb /tmp/cudnn-local-repo-ubuntu2404-9.10.2_1.0-1_amd64.deb  && \
